      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            trailing: IconButton(
              icon: Icon(contact.email == null || contact.email!.isEmpty ? Icons.edit : Icons.email,color: Colors.green,),
          ...
          ListTile(
            ...
            trailing: IconButton(
              icon: Icon(contact.streetAddress == null || contact.streetAddress!.isEmpty ? Icons.edit :Icons.map,color: Colors.green,),
              onPressed: _showMap,
            ),
          ),
        ],
